...
/**
 * Composition root for the public menu. A pure server component: it takes fully
 * resolved data and renders the whole mobile-first screen with no client state.
 */
